...
class MathCaptchaWidget(forms.MultiWidget):
    def __init__(self, start_int=1, end_int=10, question_tmpl=None,
        ...
        self.question_tmpl = (
            question_tmpl or _('Ile wynosi %(num1)i %(operator)s %(num2)i?'))
        self.question_html = None
        widget_attrs = {'size': '5','class':'form-control'}
    ...
    def format_output(self, rendered_widgets):
        ...
        output = '<div class="form-inline">%s %s</div>' % (self.question_html, output)
        return output
